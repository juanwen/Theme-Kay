...
<!-- Hero block module-->
@include('templates.3.modules.hero.hero', $hero)

@include('templates.3.modules.textblock.textblock', $textblock)

{{-- services--}}
@include('templates.3.modules.services.section', $services)
