<tr>
    ...
    <td bgcolor="ffffff">
        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="mainContent" data-module="hero">
            <tr>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0">
                        <tbody><tr>
                            <td align="center" style="font-size: 1.2em; color: #FB8A2E; font-weight: normal; text-align: center; font-family:Century Gothic;">
                                <a href="{{ $btnLink }}" style="color:#FB8A2E;text-decoration:none;letter-spacing:1px;">{{ $btn }}</a>
                            </td>
                        </tr>
                    </tbody></table>
                </td>
